	...
	export default {
		...
		methods: {
			showDialog: function() {
				...
				this.form.btnId = this.BtnInfo.btnId;
				this.form.btnName = this.BtnInfo.btnName;
				this.form.btnAlias = this.BtnInfo.btnAlias;
				this.form.btnUrl = this.BtnInfo.btnUrl;
				this.form.menuId = this.BtnInfo.menuId;
				this.form.btnMethod = this.BtnInfo.btnMethod;
				for (var i = 0;i<this.data.length;i++) {
					for (var j = 0;j<this.data.length;j++){
						var str = String(this.data[i].children[j].value);
						if(str == this.form.menuId){
							this.selectedOptions2.push(this.data[i].value);
							this.selectedOptions2.push(str);
						}
					}
